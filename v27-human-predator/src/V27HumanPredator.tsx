...
export const V27HumanPredator:React.FC=()=>{
  ...
  return <AbsoluteFill style={{background:'#050606'}}><AbsoluteFill style={{opacity:fade}}><RichScene beat={beat}/></AbsoluteFill><CaptionLayer beat={beat} fade={Math.min(1,fade+.18)}/></AbsoluteFill>;
};