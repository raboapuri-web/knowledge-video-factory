...
const Root=()=>{
  const duration=Math.max(30,Math.ceil(Number(sync.durationSeconds||1650)*30));
  return <><Composition id='V67MedievalRansom' component={V67} durationInFrames={duration} fps={30} width={1920} height={1080}/><Composition id='V67ScenePreview' component={ScenePreview} durationInFrames={beats.length*20} fps={30} width={1920} height={1080}/></>;
};
registerRoot(Root);
