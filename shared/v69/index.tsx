...
import {RESEARCHER_WOMANPreview,type ResearcherWomanAction} from '../../shared/asset-library/人物テンプレート/RESEARCHER_WOMAN';
import {ResearcherWomanBackgroundScene} from '../../shared/asset-library/人物テンプレート/researcher-woman-scene';
import {ParentFatherRigPreview,type ParentFatherAction} from '../../shared/asset-library/人物テンプレート/PARENT_FATHER';
import {ParentFatherBackgroundScene} from '../../shared/asset-library/人物テンプレート/parent-father-scene';
import {ParentMotherRig,ParentMotherRigPreview,type ParentMotherAction} from '../../shared/asset-library/人物テンプレート/PARENT_MOTHER';
import {ParentMotherBackgroundScene} from '../../shared/asset-library/人物テンプレート/parent-mother-scene';
import {V46_CHILD_RIG_BOY,V46_CHILD_RIG_BOY_PREVIEW,type ChildBoyAction} from '../../shared/asset-library/人物テンプレート/V46_CHILD_RIG_BOY';
import {V46_CHILD_RIG_GIRL,V46_CHILD_RIG_GIRL_PREVIEW,type ChildGirlAction} from '../../shared/asset-library/人物テンプレート/V46_CHILD_RIG_GIRL';
import {ChildBoyBackgroundScene} from '../../shared/asset-library/人物テンプレート/child-boy-scene';
import {ChildGirlBackgroundScene} from '../../shared/asset-library/人物テンプレート/child-girl-scene';
...
/** Female researcher, independent of male rig: idle → walk → inspect flask → point. */
const RESEARCHER_WOMANLabPreview=()=>{
  const frame=useCurrentFrame();
  const action:ResearcherWomanAction=frame<60?'idle':frame<120?'walk':frame<180?'inspectFlask':'point';
  return <ResearcherWomanBackgroundScene backgroundFile='BG_kenkyu.png'
    researcher={{x:1280,y:355,scale:.83,action,talking:action==='point'}}/>;
};
const RESEARCHER_WOMANFaceCloseup=()=>(
  <ResearcherWomanBackgroundScene backgroundFile='BG_kenkyu.png'
    researcher={{x:610,y:255,scale:1.8,action:'inspectFlask',pose:{headTilt:4}}}/>
);

/** Independent parent animations. Each component can be used without the other. */
...
/** Avoid a second background: parent-mother rig is a transparent SVG layer. */
const ParentMotherRigPreviewWrapper=({action}:{action:ParentMotherAction})=>(
  <ParentMotherRig x={1160} y={500} scale={.80} action={action}/>
);

/** Child previews: independent rigs can be overlaid without redrawing the park. */
const V46ChildBoyParkPreview=()=>{
  const frame=useCurrentFrame();
  const action:ChildBoyAction=frame<60?'front':frame<120?'run':frame<180?'play':'cry';
  return <ChildBoyBackgroundScene backgroundFile='BG_kouen.png'
    child={{x:1130,y:530,scale:.77,action}}/>;
};
const V46ChildGirlParkPreview=()=>{
  const frame=useCurrentFrame();
  const action:ChildGirlAction=frame<60?'front':frame<120?'run':frame<180?'play':'cry';
  return <ChildGirlBackgroundScene backgroundFile='BG_kouen.png'
    child={{x:1130,y:530,scale:.77,action}}/>;
};
const V46ChildrenTogetherPreview=()=>{
  const frame=useCurrentFrame();
  const boyAction:ChildBoyAction=frame<60?'front':frame<120?'run':frame<180?'play':'cry';
  const girlAction:ChildGirlAction=boyAction;
  return <ChildBoyBackgroundScene backgroundFile='BG_kouen.png'
    child={{x:670,y:530,scale:.77,action:boyAction}}>
      <V46_CHILD_RIG_GIRL x={1150} y={530} scale={.77} action={girlAction}/>
    </ChildBoyBackgroundScene>;
};

const Root=()=>{
  const duration=Math.max(30,Math.ceil(Number(sync.durationSeconds||1700)*30));
  return <><Composition id='V69FreeServices' component={V69} durationInFrames={duration} fps={30} width={1920} height={1080}/><Composition id='V69ScenePreview' component={ScenePreview} durationInFrames={beats.length*20} fps={30} width={1920} height={1080}/><Composition id='OfficeWorkerRigPreview' component={OfficeWorkerRigPreview} durationInFrames={240} fps={30} width={1920} height={1080}/><Composition id='OfficeWorkerOfficePreview' component={OfficeWorkerOfficePreview} durationInFrames={240} fps={30} width={1920} height={1080}/><Composition id='OfficeWorkerNeckCloseup' component={OfficeWorkerNeckCloseup} durationInFrames={60} fps={30} width={1920} height={1080}/><Composition id='OfficeWomanRigPreview' component={OfficeWomanRigPreview} durationInFrames={240} fps={30} width={1920} height={1080}/><Composition id='OfficeWomanOfficePreview' component={OfficeWomanOfficePreview} durationInFrames={240} fps={30} width={1920} height={1080}/><Composition id='OfficeWomanFaceCloseup' component={OfficeWomanFaceCloseup} durationInFrames={60} fps={30} width={1920} height={1080}/><Composition id='PASSERBYPreview' component={PASSERBYPreview} durationInFrames={270} fps={30} width={1920} height={1080}/><Composition id='PASSERBYTownPreview' component={PASSERBYTownPreview} durationInFrames={270} fps={30} width={1920} height={1080}/><Composition id='ResearcherManPreview' component={RESEARCHER_MANPreview} durationInFrames={240} fps={30} width={1920} height={1080}/><Composition id='ResearcherManLabPreview' component={RESEARCHER_MANLabPreview} durationInFrames={240} fps={30} width={1920} height={1080}/><Composition id='ResearcherManFaceCloseup' component={RESEARCHER_MANFaceCloseup} durationInFrames={60} fps={30} width={1920} height={1080}/><Composition id='ResearcherWomanPreview' component={RESEARCHER_WOMANPreview} durationInFrames={240} fps={30} width={1920} height={1080}/><Composition id='ResearcherWomanLabPreview' component={RESEARCHER_WOMANLabPreview} durationInFrames={240} fps={30} width={1920} height={1080}/><Composition id='ResearcherWomanFaceCloseup' component={RESEARCHER_WOMANFaceCloseup} durationInFrames={60} fps={30} width={1920} height={1080}/><Composition id='ParentFatherRigPreview' component={ParentFatherRigPreview} durationInFrames={240} fps={30} width={1920} height={1080}/><Composition id='ParentFatherRoomPreview' component={ParentFatherRoomPreview} durationInFrames={240} fps={30} width={1920} height={1080}/><Composition id='ParentMotherRigPreview' component={ParentMotherRigPreview} durationInFrames={240} fps={30} width={1920} height={1080}/><Composition id='ParentMotherRoomPreview' component={ParentMotherRoomPreview} durationInFrames={240} fps={30} width={1920} height={1080}/><Composition id='ParentsTogetherPreview' component={ParentsTogetherPreview} durationInFrames={240} fps={30} width={1920} height={1080}/><Composition id='V46ChildBoyPreview' component={V46_CHILD_RIG_BOY_PREVIEW} durationInFrames={240} fps={30} width={1920} height={1080}/><Composition id='V46ChildGirlPreview' component={V46_CHILD_RIG_GIRL_PREVIEW} durationInFrames={240} fps={30} width={1920} height={1080}/><Composition id='V46ChildBoyParkPreview' component={V46ChildBoyParkPreview} durationInFrames={240} fps={30} width={1920} height={1080}/><Composition id='V46ChildGirlParkPreview' component={V46ChildGirlParkPreview} durationInFrames={240} fps={30} width={1920} height={1080}/><Composition id='V46ChildrenTogetherPreview' component={V46ChildrenTogetherPreview} durationInFrames={240} fps={30} width={1920} height={1080}/><Composition id='HoodieGirlRigPreview' component={HoodieGirlRigPreview} durationInFrames={480} fps={30} width={1920} height={1080}/><Composition id='HoodieGirlRoomPreview' component={HoodieGirlRoomPreview} durationInFrames={480} fps={30} width={1920} height={1080}/><Composition id='HoodieGirlNeckCloseup' component={HoodieGirlNeckCloseup} durationInFrames={60} fps={30} width={1920} height={1080}/><Composition id='HoodieGirlPhoneCloseup' component={HoodieGirlPhoneCloseup} durationInFrames={60} fps={30} width={1920} height={1080}/><Composition id='HoodieBoyRigPreview' component={HoodieBoyRigPreview} durationInFrames={480} fps={30} width={1920} height={1080}/><Composition id='HoodieBoyRoomPreview' component={HoodieBoyRoomPreview} durationInFrames={480} fps={30} width={1920} height={1080}/><Composition id='HoodieBoyFaceCloseup' component={HoodieBoyFaceCloseup} durationInFrames={60} fps={30} width={1920} height={1080}/><Composition id='HoodieBoyPhoneCloseup' component={HoodieBoyPhoneCloseup} durationInFrames={60} fps={30} width={1920} height={1080}/></>;
};
registerRoot(Root);
