...
<Composition id="V82ResaleEconomics" component={Film} fps={30} durationInFrames={total} width={1920} height={1080}/>
<Composition id="V82ScenePreview" component={Preview} fps={30} durationInFrames={beats.length*24} width={1920} height={1080}/></>;};
registerRoot(Root);
