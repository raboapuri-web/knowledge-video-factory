...
const Root=()=>{
  ...
  return <><Composition id='V68IncomeHappiness' component={V68} durationInFrames={duration} fps={30} width={1920} height={1080}/><Composition id='V68ScenePreview' component={ScenePreview} durationInFrames={beats.length*20} fps={30} width={1920} height={1080}/></>;
};
registerRoot(Root);
