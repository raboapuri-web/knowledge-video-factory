...
const Root=()=>{
  ...
  return <><Composition id='V63ExiledMasterpieces' component={V63} durationInFrames={duration} fps={30} width={1920} height={1080}/><Composition id='V63ScenePreview' component={ScenePreview} durationInFrames={beats.length*20} fps={30} width={1920} height={1080}/></>;
};
registerRoot(Root);
