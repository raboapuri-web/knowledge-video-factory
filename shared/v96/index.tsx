...
const Root=()=>{
  const duration=Math.max(30,Math.ceil(Number(sync.durationSeconds||1280)*30));
  return <><Composition id='V96Goosebumps' component={V96} durationInFrames={duration} fps={30} width={1920} height={1080}/><Composition id='V96ScenePreview' component={ScenePreview} durationInFrames={beats.length*20} fps={30} width={1920} height={1080}/></>;
};
registerRoot(Root);
