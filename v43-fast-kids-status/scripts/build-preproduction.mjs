...
const scenes=script.beats.map((b,i)=>({
  id:b.id,
  summary:b.narration.slice(0,42),
  sceneType:b.visual,
  templateSource:'One-off',
  visualIntent:`${b.visual}を台本固有の背景・人物配置・小道具・カメラ移動・前景アニメーションで表現し、前後シーンと背景構成を重複させない`,
  estimatedSeconds:18+(i%3)
}));
