...
const SceneSpecificMotion=({scene,t,index}:{scene:any;t:number;index:number})=>{
 ...
 if(sid==='V46-C3-047')return <AbsoluteFill><PersonIcon x={220} y={420} s={1}/>{['house','money','clock','work','heart'].map((k,i)=><React.Fragment key={k}><SymbolCard x={530+i*250} y={250+(i%2)*300} kind={k} t={t} delay={i*.06}/>{i<4&&<Arrow x1={690+i*250} y1={360+(i%2)*300} x2={780+i*250} y2={520+((i+1)%2)*200} opacity={.55}/>}</React.Fragment>})}</AbsoluteFill>;
