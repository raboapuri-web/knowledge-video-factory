...
export const Chapter3Scene=({scene,index,frames}:{scene:any;index:number;frames:number})=>{
  ...
  switch(index){
    ...
    case 33:return <AbsoluteFill><CityBase/><V46_ADULT_MAN_RIG x={260} y={330} scale={.7} tieVisible={false}/><OfficeBase/><div style={{position:'absolute',left:1030,top:170,width:710,height:700,background:'rgba(8,13,18,.22)',borderRadius:30}}/><V46_ADULT_MAN_RIG x={1180} y={300} scale={.74} tieVisible={false} showBriefcase/><Clock x={1500} y={190} s={1.1} rot={t*220}/></AbsoluteFill>;
