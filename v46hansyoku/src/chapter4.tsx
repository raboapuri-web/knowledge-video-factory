...
export const Chapter4Scene=({scene,index,frames}:{scene:any;index:number;frames:number})=>{
 ...
 switch(index){
  ...
  case 28:return <AbsoluteFill style={{background:'#0b1015'}}><City/><div style={{position:'absolute',inset:0,opacity:q}}><RuralField/></div><div style={{position:'absolute',left:150,top:160,width:1620,height:18,background:'#d4c17f',transform:'scaleX('+(1-q)+')',transformOrigin:'right'}}/></AbsoluteFill>;
