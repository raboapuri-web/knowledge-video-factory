...
import plan from '../scene-plans/epilogue.json';
...
if(sy.status!=='measured_voicevox_epilogue'||!sy.approvedNarration)throw new Error('measured voice required epilogue');
...
if(timeline.some((b:any,i:number)=>b.frames<=0||(i>0&&b.from!==timeline[i-1].from+timeline[i-1].frames)))throw new Error('timing gap epilogue');
