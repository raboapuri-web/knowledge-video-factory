...
const categoryBackgrounds={
 ...
 facility:new Set(['BG_TOYOKO_GROUND','BG_SHELTER_ENTRANCE','BG_SHELTER_BEDROOM','BG_SHELTER_DINING','BG_SHELTER_COUNSEL','BG_YOUTH_CENTER','BG_TOWN_DAY_WIDE','BG_ABROAD_SHELTER']),
