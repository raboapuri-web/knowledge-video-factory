...
import {RichSceneV36,type Beat} from './scenes-v36';
...
export const V36Frenemy:React.FC=()=>{
  ...
  return <AbsoluteFill style={{background:'#020304'}}><AbsoluteFill style={{opacity:fade}}><RichSceneV36 beat={beat}/></AbsoluteFill><Subtitle beat={beat} progress={active.progress} fade={Math.min(1,fade+.24)}/></AbsoluteFill>;
};
